...
public class QuoteOfferController {
     ...
     */
    @ResponseBody 
    @GetMapping(value = "/listquotesjson", produces = MediaType.APPLICATION_JSON_VALUE)  
    ...
    public  ResponseEntity<String>  createQuotes(@RequestBody  @Validated  
    		Quotes quotes, BindingResult result, HttpServletRequest request, 
    		HttpServletResponse response) throws Exception { 
