...
export class HttptoserverService extends BaseserviceService {
  // if deploy binding angukar together the baseUrl ='/appName' r '' because server/port will be same as angular
  ...
  getQuotes(): Observable<Quotes[]> {
    return this.http.get<Quotes[]> (this.baseUrl+'/listquotesjson');
  }
